    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                self.Text1.insert(INSERT, " Painting Sold! ""\n")
                v = int(self.rom)
                f = open("hotel.dat", "rb")
                f1 = open("hote.dat", "ab")
                n = 0
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT, "No painting found.""\n")

                    elif n == 1:

                        self.Text1.insert(INSERT, "Thank you for buying  " + name1.upper() + " from us.""\n")
                    pass
                f.close()
                f1.close()
                os.remove("hotel.dat")
                ...
                self.Text1.insert(INSERT, "Invalid painting number.""\n")
        ...
        self.Button1.configure(background="#b3ccff")
        ...
        self.Button1.configure(text='''BUY PAINTING''')
