...
class ART_MANGMENT_checkin:
    def __init__(self):
        ...
        self.Labelframe1.configure(text='''LIST OF PAINTINGS''')
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="#99ccff")
        ...
        self.Label2.configure(text='''NUMBER''')
