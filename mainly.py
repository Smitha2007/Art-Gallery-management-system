...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        _bgcolor = '#809fff'  # X11 color: 'gray85'
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#99ccff")
        ...
        self.Message6.configure(background="#ffcccc")
        ...
        self.Button2.configure(background="#ffe6e6")
        self.Button2.configure(disabledforeground="#ffe6e6")
        self.Button2.configure(font=font14)
        self.Button2.configure(foreground="#000000")
        self.Button2.configure(highlightbackground="#d9d9d9")
        self.Button2.configure(highlightcolor="black")
        self.Button2.configure(pady="0")
        self.Button2.configure(text='''1. ARTIST''')
        ...
        self.Button3.configure(background="#ffe6e6")
        ...
        self.Button3.configure(text='''2. PAINTING LIST''')
        ...
        self.Button4.configure(background="#ffe6e6")
        ...
        self.Button4.configure(text='''3. BUY''')
        ...
        self.Button5.configure(background="#ffe6e6")
        ...
        self.Button5.configure(text='''4.EXHIBITION''')
        ...
        self.Button6.configure(background="#ffe6e6")
